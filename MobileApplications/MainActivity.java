...
//    private final String BT_ADDR = "F6:D7:BF:73:72:D3";
    public static final String BT_ADDR = "98:4F:EE:0F:A3:AB";


    Context mContext;
    BluetoothLeModel mBluetoothLeModel;

    // Andrew: Min SDK was changed to 19, then to 21
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Andrew: Created connect button click listener
        connectButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                // Uncommented mBluetoothLeModel, put it in here
                BluetoothLeService.CONNECT(mContext, mBluetoothLeModel);
            }
        });

        // Andrew: Created disconnect button click listener
        disconnectButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                BluetoothLeService.DISCONNECT(mContext, mBluetoothLeModel);
            }
        });
    }
