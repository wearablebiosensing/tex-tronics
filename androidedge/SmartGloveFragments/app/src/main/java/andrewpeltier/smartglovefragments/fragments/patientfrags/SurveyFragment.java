...
public class SurveyFragment extends Fragment {
    ...
    int o_f;
    float _time;
    String _comments, age_str, year_str, mon_str, time_str;
        ...
        nextButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(empty){
                    ...
                    User user = new User(_age,m_f,r_l,dur_len,_time,o_f,_comments);
                    UserRepository.getInstance(getActivity().getApplicationContext()).insertUsr(_age,m_f,r_l,dur_len,_time,o_f,_comments);
                    ...
                    String jsonPaitent = "Age: " + age_str + "," + " Gender: " + Integer.toString(m_f) + ","+ " Duration: " + Integer.toString(dur_len) + "," + " Handedness: "+
                            Integer.toString(r_l) + "," + " Dose: " + time_str + "," + " Feel: " + Integer.toString(o_f) + "," + " Comments: " + _comments + "\n";
