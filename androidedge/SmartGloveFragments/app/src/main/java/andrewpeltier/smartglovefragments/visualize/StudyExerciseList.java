...
public class StudyExerciseList {
    ...
    public List<StudyExercise> getStudyExercises()
    {
        return Arrays.asList(
                ...
                new StudyExercise("Heel_Stomp", "Heel_Stomp", StudyChoice.HEEL_STOMP, "Shoe"),
                new StudyExercise("Toe_Tap", "Toe_Tap", StudyChoice.TOE_TAP, "Shoe"),
                new StudyExercise("Walk_Steps",  "Walk_Steps", StudyChoice.GAIT, "Shoe"));
    }
}
