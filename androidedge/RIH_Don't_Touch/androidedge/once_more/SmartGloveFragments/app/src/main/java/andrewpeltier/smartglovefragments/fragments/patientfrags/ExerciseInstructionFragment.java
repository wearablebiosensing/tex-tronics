...
public class ExerciseInstructionFragment extends Fragment
{
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        /*
        * CHECK CONNECTION TO EACH DEVICE BEFORE THE EXERCISE STARTS.
        * ===========================================================
        * */

        checkConnection(MainActivity.exercise_name);
...
//        }
    ...
    private void checkConnection(String exercise_name)
    {
        ...
        if(deviceAddressList != null && deviceAddressList.length > 0 && MainActivity.CONNECTED)
        {
            for(int devindex = 0; devindex<deviceAddressList.length; devindex++) {
                ...
                //------------------------------------------------------------
                if (/*exercise_modes.equals("Imu Only")*/exercise_name.equals("Hold_Hands_Out") || exercise_name.equals("Resting_Hands_on_Thighs")
                        || exercise_name.equals("Hand_Flip")
                ) {
                    flag = 3;
                    Log.e(TAG, "flag=" + flag);
                } else if (/*exercise_modes.equals("Flex Only")*/exercise_name.equals("Finger_to_Nose") || exercise_name.equals("Heel_Stomp")
                        || exercise_name.equals("Finger_Tap") || exercise_name.equals("Toe_Tap") || exercise_name.equals("Closed_Grip") || exercise_name.equals("Walk_Steps")) {
                    flag = 3;
                    Log.e(TAG, "flag=" + flag);
                }
                //------------------------------------------------------------
                ...
                String exerciseDeviceType = Exercise.getDeviceName(exercise_name);
