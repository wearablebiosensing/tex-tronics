...
public interface SmartGloveInterface
{
    ...
    {
        String FINGER_TAP_TEXT = "Tap your index finger\n\t to your thumb 10x";
        ...
        String HEEL_TAP_TEXT = "Tap your heel against\n\t\t\t the floor 10x";
        String TOE_TAP_TEXT = "Tap your toe against\n\t\t the floor 10x";
        String FOOT_STOMP_TEXT = "Stomp your feet against\n\t\t\t\t the floor 10x";
