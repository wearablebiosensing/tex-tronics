...
public class GloveExerciseActivity extends AppCompatActivity implements SmartGloveInterface
{
    ...
    protected void onCreate(Bundle savedInstanceBundle)
    {
        ...
        sideInstructionsText = findViewById(R.id.instructions_text);
        sideImage = findViewById(R.id.stexercise_side_image);
        if(intent != null)
...
//                Intent intent = getIntent();
                TexTronicsExerciseManager.startExercise(mContext);
//                TexTronicsExerciseManager.setIntent(intent);
//                intent = new Intent(mContext, ExerciseInstructions.class);
